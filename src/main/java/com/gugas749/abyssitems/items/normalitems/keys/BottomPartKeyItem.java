...
public class BottomPartKeyItem extends Item {
    public BottomPartKeyItem() {
    ...
    public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> tooltipComponents, TooltipFlag flag) {
        tooltipComponents.add(Component.translatable("item.abyssitems.bottom_part_key.tooltip"));
    }
}
